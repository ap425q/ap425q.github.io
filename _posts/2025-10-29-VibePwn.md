...
![All supported agents](../images/supported_agents.png)
...
![Agents.md Location](../images/location.png)
...
![Phishing Link](../images/phish.png)
...
![change purple theme image](../images/purple.png)

I could see that a terminal opened, my command ran successfully, and I got a callback on my netcat listener.

![reverse shell callback image](../images/rev_shell.png)

![Netcat Output](../images/netcat.png)
